...
public class DifficultSelector : MonoBehaviour
{
    ...
    public void UnlockINTERMEDIO()
    {
        ...
        if (GameController.globalDistanciaRecorrida4 >= 65 && GameController.diamonds >= 25)
        {
    ...
    public void UnlockCASIPRO()
    {
        ...
        if (GameController.globalDistanciaRecorrida4 >= 160 && GameController.diamonds >= 55 && LEVEL_INTERMEDIO == 1)
        {
    ...
    {
        MenusManager.MenusManagerInstance.BackSound();
        if (GameController.globalDistanciaRecorrida4 >= 240 && GameController.diamonds >= 100 && LEVEL_INTERMEDIO == 1 && LEVEL_CASIPRO == 1)
        {
